...
[![amd64/httpd build status badge](https://img.shields.io/jenkins/s/https/doi-janky.infosiftr.net/job/multiarch/job/amd64/job/httpd.svg?label=amd64/httpd%20%20build%20job)](https://doi-janky.infosiftr.net/job/multiarch/job/amd64/job/httpd/)
...
The `amd64/httpd` images come in many flavors, each designed for a specific use case.

## `amd64/httpd:<version>`

This is the defacto image. If you are unsure about what your needs are, you probably want to use this one. It is designed to be used both as a throw away container (mount your source code and start the container to start your app), as well as the base to build other images off of.

## `amd64/httpd:<version>-alpine`
