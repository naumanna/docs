...
[![s390x/httpd build status badge](https://img.shields.io/jenkins/s/https/doi-janky.infosiftr.net/job/multiarch/job/s390x/job/httpd.svg?label=s390x/httpd%20%20build%20job)](https://doi-janky.infosiftr.net/job/multiarch/job/s390x/job/httpd/)
