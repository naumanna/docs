...
[![ppc64le/irssi build status badge](https://img.shields.io/jenkins/s/https/doi-janky.infosiftr.net/job/multiarch/job/ppc64le/job/irssi.svg?label=ppc64le/irssi%20%20build%20job)](https://doi-janky.infosiftr.net/job/multiarch/job/ppc64le/job/irssi/)
...
The `ppc64le/irssi` images come in many flavors, each designed for a specific use case.

## `ppc64le/irssi:<version>`

This is the defacto image. If you are unsure about what your needs are, you probably want to use this one. It is designed to be used both as a throw away container (mount your source code and start the container to start your app), as well as the base to build other images off of.

## `ppc64le/irssi:<version>-alpine`
