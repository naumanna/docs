...
### Using environment variables in arm32v6/nginx configuration

Out-of-the-box, arm32v6/nginx doesn't support environment variables inside most configuration blocks. But `envsubst` may be used as a workaround if you need to generate your arm32v6/nginx configuration dynamically before arm32v6/nginx starts.
