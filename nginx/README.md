...
Out-of-the-box, arm32v7/nginx doesn't support environment variables inside most configuration blocks. But `envsubst` may be used as a workaround if you need to generate your arm32v7/nginx configuration dynamically before arm32v7/nginx starts.
