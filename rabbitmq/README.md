...
-	[`3.8.0-beta.4`, `3.8-rc`](https://github.com/docker-library/rabbitmq/blob/1ddf81675fc05dcb315283a4cf33b71a1248224c/3.8-rc/ubuntu/Dockerfile)
-	[`3.8.0-beta.4-management`, `3.8-rc-management`](https://github.com/docker-library/rabbitmq/blob/3a5957b93e31661739a9018bc2ae5d20f1bfae59/3.8-rc/ubuntu/management/Dockerfile)
-	[`3.8.0-beta.4-alpine`, `3.8-rc-alpine`](https://github.com/docker-library/rabbitmq/blob/1ddf81675fc05dcb315283a4cf33b71a1248224c/3.8-rc/alpine/Dockerfile)
-	[`3.8.0-beta.4-management-alpine`, `3.8-rc-management-alpine`](https://github.com/docker-library/rabbitmq/blob/3a5957b93e31661739a9018bc2ae5d20f1bfae59/3.8-rc/alpine/management/Dockerfile)
-	[`3.7.16`, `3.7`, `3`, `latest`](https://github.com/docker-library/rabbitmq/blob/a6c719b456a2745508511d0d3dc1db667cbdc7e7/3.7/ubuntu/Dockerfile)
...
-	[`3.7.16-alpine`, `3.7-alpine`, `3-alpine`, `alpine`](https://github.com/docker-library/rabbitmq/blob/a6c719b456a2745508511d0d3dc1db667cbdc7e7/3.7/alpine/Dockerfile)
...
```console
$ docker run -d --hostname some-rabbit --name some-rabbit --network some-network -e RABBITMQ_ERLANG_COOKIE='secret cookie here' arm64v8/rabbitmq:3
```

This can then be used from a separate instance to connect:

```console
$ docker run -it --rm --network some-network -e RABBITMQ_ERLANG_COOKIE='secret cookie here' arm64v8/rabbitmq:3 bash
...
```console
$ docker run -it --rm --network some-network -e RABBITMQ_ERLANG_COOKIE='secret cookie here' -e RABBITMQ_NODENAME=rabbit@some-rabbit arm64v8/rabbitmq:3 bash
