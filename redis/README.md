...
[![ppc64le/redis build status badge](https://img.shields.io/jenkins/s/https/doi-janky.infosiftr.net/job/multiarch/job/ppc64le/job/redis.svg?label=ppc64le/redis%20%20build%20job)](https://doi-janky.infosiftr.net/job/multiarch/job/ppc64le/job/redis/)
...
```console
$ docker run -it --network some-network --rm ppc64le/redis redis-cli -h some-redis
```
